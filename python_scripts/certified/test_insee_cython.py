...
for prec in [1,2,3]:
    ...
    geo_insee_dic = help_ses.generate_insee_ses_data(prec=prec)
    print("TWITTER DATA ...")
    ...
    print("CYTHON TEST ...")
    loc2insee=help_ses.insee_sjoin(dgeo_prof_france_14,geo_insee_dic,prec=prec)
    elapsed_time = time.time() - start_time
    print ("Ellapsed Time for prec %d : %.2f s"%(prec,elapsed_time))
