...
names = ["Nearest Neighbors", "Linear SVM 1","Linear SVM 2", "RBF SVM", "Gaussian Process",
         "Decision Tree", "Random Forest", "Neural Net 1","Neural Net 2","Neural Net 3", "AdaBoost",
         "Naive Bayes", "QDA"]
...
for name, clf in zip(names, classifiers):
    score=cross_val_score(clf, X, y=ses_iris_class_try, cv=10)
